# Autogenerated wrapper script for LibAMVW_jll for x86_64-w64-mingw32-libgfortran5
...
const libamvwdouble_splitpath = ["bin", "libamvwdouble.dll"]
...
const libamvwdouble = "libamvwdouble.dll"


# Relative path to `libamvwsingle`
const libamvwsingle_splitpath = ["bin", "libamvwsingle.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamvwsingle = "libamvwsingle.dll"
