# Autogenerated wrapper script for LibAMVW_jll for x86_64-apple-darwin14-libgfortran4
export libamvwdouble, libamvwsingle
...
const libamvwdouble_splitpath = ["lib", "libamvwdouble.dylib"]
...
const libamvwdouble = "@rpath/libamvwdouble.dylib"


# Relative path to `libamvwsingle`
const libamvwsingle_splitpath = ["lib", "libamvwsingle.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamvwsingle = "@rpath/libamvwsingle.dylib"
