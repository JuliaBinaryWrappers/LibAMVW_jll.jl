...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import LibAMVW_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3420f54a-cca3-5752-a4b4-c8f5453f04ac"))
platforms = [Pkg.Artifacts.unpack_platform(e, "LibAMVW", artifacts_toml) for e in artifacts["LibAMVW"]]
...
if best_platform === nothing
    @debug("Unable to load LibAMVW; unsupported platform $(triplet(platform_key_abi()))")
else
